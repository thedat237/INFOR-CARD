    ...
    return (
        <>
            <div className='banner-step d-flex justify-content-center mb-5'>
                <img src={bannerStep} className="img-fluid"/>
            </div>
            ...
            <div className='container pb-5 d-flex flex-column'>
                ...
                <div className='step-info d-flex align-items-center'>
                    <img src={bannerSocial} className="img-fluid"/>
                    <h3 className='col-sm-4'><span>Khi nhận hàng, bạn nhận</span><span>được thẻ và tờ hướng dẫn,</span><span>bạn làm theo tờ hướng dẫn</span><span>để tự thêm thông tin cá</span> nhân vào thẻ.</h3>
                </div>
            </div>
            ...
            <div className='container m-5 pb-5 d-flex flex-column'>
                ...
                <div className='step-info-3 d-flex align-items-center justify-content-between'>
                    <img src={bannerCard3} className='step-phone-img img-fluid'/>
                    <div className='d-flex flex-column align-items-center'>
                        <img src={bannerPhone2} className='step-phone-img img-fluid'/>
                    ...
                    <div className='d-flex flex-column align-items-center'>
                        <img src={bannerPhone} className='step-phone-img img-fluid'/>
                        <div className='d-flex flex-column align-items-center'>
                            <h4>CHẠM THẺ</h4>
                            <h6>Hoạt động trên hầu hết điện thoại Android & iOS</h6>
